...
<form class="form-horizontal" method="post" action="/job/edit/${model.sid }">
	...
	<div class="form-group">
		...
		<div class="col-md-10">
			<textarea class="form-control" id="description" name="description" rows="12">${model.description}</textarea>
		</div>
	</div>
	<div class="form-group">
